...
class Genetic extends Component {
    constructor(props) {
      ...
      fetchStatus() {
        fetch('http://127.0.0.1:5000/algorytm_genetyczny')
    ...
    render() {
        ...
        return (
        <>
         <div className = "Home" > <h1>Algorytm genetyczny</h1></div>
            <Map trasy={this.state.dane.lista_wsporzednych_tras} liczba={2} centerList={[this.props.x,this.props.y]}/>
